...
namespace MyApp.Manage
{
    ...
    public interface IOrgManage
    {
        ...
        Task<List<Organization>> GetRootOrganizations();
        ...
        Task<PagedResult<Organization>> GetOrganizations(OrgQuery query);

        /// <summary>
        /// 保存一个组织信息
        /// </summary>
        /// <param name="organization">待保存的组织，如果 id > 0 表示更新，否则为新增。</param>
        /// <returns>保存后的组织信息id</returns>
        Task<long> SaveOrganization(Organization organization);
